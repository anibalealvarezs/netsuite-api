...
- Purpose: This package operates within the Communication (SDKs) layer of the APIs Hub SaaS hierarchy, providing NetSuite API client functionality.
- Dependency stance: Consumes `anibalealvarezs/api-client-skeleton` and serves the `netsuite-hub-driver`.
## Local working rules
...
## Current notes
- NetSuite client is the source-facing SDK for the NetSuite driver.